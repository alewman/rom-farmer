...
type-check-core:
	mypy src/romfarmer/ir src/romfarmer/engine src/romfarmer/analysis src/romfarmer/planner src/romfarmer/targets src/romfarmer/driver src/romfarmer/intent
