...
- **Validated end-to-end on real collections:** cartridge → 7z (full NES set), disc → CHD (single and multi-disc with M3U), arcade passthrough (Neo Geo: identical set to the previous pipeline), GameCube RVZ. **Not yet exercised through the compiler:** Wii U WUX, Xbox XISO→SquashFS, PS3.
