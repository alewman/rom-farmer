...
class SizeDatabase:
    ...
    def get_summary(self, platform: str) -> Optional[Dict]:
        ...
        return {
            ...
            'compressions': list(set(r['compression'] for r in records)),
            'last_updated': records[-1]['timestamp'],
        }


# Global instance for convenience
_size_db: Optional[SizeDatabase] = None


def get_size_db(db_path: Optional[Path] = None) -> SizeDatabase:
