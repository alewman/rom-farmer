...
class DatGame:
    ...
    cloneof: str | None = None  # Parent game name
    romof: str | None = None  # ROM parent (for merged sets)
    sampleof: str | None = None  # Sample parent

    # Hardware/driver info
    sourcefile: str | None = None  # Driver source (e.g., "capcom/d_cps1.cpp")
    ...
    # Metadata
    comment: str | None = None  # Bootleg, Prototype, etc.
    category: str | None = None

    # ROM hashes (first ROM only for identification)
    rom_name: str | None = None
    rom_crc: str | None = None
    rom_size: int | None = None

    # Source DAT info
    dat_name: str | None = None
    dat_type: str | None = None  # fbneo, mame, nointro, redump
    ...
    @property
    def hardware_family(self) -> str | None:
...
class DatParser:
    ...
    def __init__(self, dat_path: Path):
        ...
        self.dat_name: str | None = None
        self.dat_description: str | None = None
        self.dat_version: str | None = None
        self.dat_type: str | None = None
    ...
    def _parse_video(self, game_elem: ET.Element) -> VideoSpec | None:
        """Parse video element."""
