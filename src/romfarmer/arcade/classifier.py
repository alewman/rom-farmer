...
ESSENTIAL_HACKS = {
    ...
    "sf2rb", "sf2rb2", "sf2rb3", "sf2rb4", "sf2rb5", "sf2rb6",
    # Street Fighter II - Other famous mods
    "sf2koryu", "sf2koryu2", "sf2koryu3",  # Koryu (Korean hack)
    "sf2m1", "sf2m2", "sf2m3", "sf2m4", "sf2m5", "sf2m6", "sf2m7",  # Magic variants
    "sf2yyc", "sf2yyc2",  # YYC
    # Ms. Pac-Man (originally a hack kit, became official)
    "mspacman", "mspacmab", "mspacmat",
    # Pac-Man Plus
    "pacplus",
    # Donkey Kong hacks
    "dkong3b",  # Bootleg
...
class ArcadeClassifier:
    ...
    def __init__(
        self,
        essential_hacks: Optional[set[str]] = None,
        quality_homebrew: Optional[set[str]] = None,
    ):
    ...
    def _classify_from_comment(
        self, game: DATGame
    ) -> tuple[ArcadeCloneType, CloneImportance]:
    ...
    def _extract_region(self, game: DATGame) -> Optional[str]:
    ...
    def _extract_revision(self, game: DATGame) -> Optional[str]:
        ...
        for pattern, replacement in rev_patterns:
    ...
    def get_region_priority(self, region: Optional[str]) -> int:
