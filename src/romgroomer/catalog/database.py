...
class RomGroomerDatabase:
    """
    Database manager for ROM Groomer catalog.
    ...
    def get_dat_file(self, session: Session, name: str) -> Optional[DatFile]:
    ...
    def get_rom_file(self, session: Session, path: str) -> Optional[RomFile]:
