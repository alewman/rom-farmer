...
class DatRom:
    ...
    status: Optional[str] = None  # verified, good, bad, etc.
...
class DatParser:
    ...
    def __init__(self):
        self.header: Optional[DatHeader] = None
    ...
    def _parse_release(self, release_elem: ET.Element) -> Optional[DatRelease]:
    ...
    def find_game_by_crc(self, crc: str) -> Optional[DatGame]:
        """
