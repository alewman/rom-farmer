...
from ..dat import DatParser, DatGame as ParsedDatGame
from ..catalog.database import RomGroomerDatabase, DatFile, DatGame
...
class DatImportService:
    ...
    def get_dat_info(self, dat_name: str) -> Optional[DatFile]:
        """
    ...
    def get_statistics(self, dat_name: Optional[str] = None) -> dict:
        """
