"""
Centralized path resolution for ROM Groomer.
...
Usage:
    from romgroomer.core.paths import paths
...
class PathResolver:
    ...
    2. Configuration file (romgroomer.yaml or .romgroomer.yaml)
    3. Sensible defaults relative to workspace root
    
    Attributes:
        workspace_root: The root directory of the ROM Groomer workspace
    """
    ...
    def _load_config(self, config_file: Optional[Path]) -> dict:
        ...
        for name in ["romgroomer.yaml", ".romgroomer.yaml"]:
    ...
    def workspace_root(self) -> Path:
        """Root directory of the ROM Groomer workspace."""
    ...
    def metadata_db(self) -> Path:
        ...
        return self.metadata_dir / "romgroomer.db"
