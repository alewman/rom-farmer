...
from romfarmer.catalog.database import DatFile, DatGame
...
class TestOneGameOneRomFilter:
    ...
    def test_prefer_parents(self):
        ...
        games = [
            ...
            DatGame(
                id=2, name="Game (USA) [!]", rom_name="game_verified.rom", crc="222", size=1000
            ),
    ...
    def test_revision_preference(self):
        ...
        games = [
            DatGame(id=1, name="Game (USA)", rom_name="game.rom", crc="111", size=1000),
            DatGame(
                id=2, name="Game (USA) (Rev 1)", rom_name="game_rev1.rom", crc="222", size=1000
            ),
            DatGame(
                id=3, name="Game (USA) (Rev 2)", rom_name="game_rev2.rom", crc="333", size=1000
            ),
        ]
    ...
    def test_revision_letters(self):
        ...
        games = [
            DatGame(
                id=1, name="Game (USA) (Rev A)", rom_name="game_reva.rom", crc="111", size=1000
            ),
            DatGame(
                id=2, name="Game (USA) (Rev B)", rom_name="game_revb.rom", crc="222", size=1000
            ),
        ]
    ...
    def test_disable_revision_preference(self):
        ...
        games = [
            DatGame(id=1, name="Game (USA)", rom_name="game.rom", crc="111", size=1000),
            DatGame(
                id=2, name="Game (USA) (Rev 2)", rom_name="game_rev2.rom", crc="222", size=1000
            ),
        ]
    ...
    def test_base_name_extraction(self):
        ...
        for full_name, expected_base in test_cases:
            ...
            assert base == expected_base, (
                f"Failed for {full_name}: got {base}, expected {expected_base}"
            )
