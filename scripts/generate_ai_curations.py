...
PS2_ESSENTIAL = [
    ...
    (
        "Metal Gear Solid 3 - Subsistence (USA) (En,Es) (Disc 1) (Subsistence)",
        99,
        ["masterpiece", "stealth"],
        "Best MGS. Definitive edition with 3D camera",
    ),
    (
        "Metal Gear Solid 3 - Subsistence (USA) (En,Es) (Disc 2) (Persistence)",
        99,
        ["multi-disc"],
        "MGS3 Disc 2 — online/bonus content",
    ),
    (
        "Final Fantasy X (USA, Canada)",
        98,
        ["masterpiece", "jrpg"],
        "Last great turn-based mainline FF",
    ),
    (
        "Kingdom Hearts II (USA)",
        98,
        ["masterpiece", "action-rpg"],
        "Peak of Disney/Square crossover",
    ),
    ...
    (
        ...
        "Biggest GTA, peak PS2 open world",
    ),
    (
        "Shin Megami Tensei - Persona 4 (USA)",
        97,
        ["masterpiece", "jrpg"],
        "Best Persona. Murder mystery + social sim",
    ),
    (
        "Shin Megami Tensei - Persona 3 FES (USA)",
        96,
        ["masterpiece", "jrpg"],
        "Reinvented the JRPG. Social link pioneer",
    ),
    ...
    (
        ...
        96,
        ["masterpiece", "action-rpg"],
        "The impossible crossover that worked",
    ),
    (
        "Silent Hill 2 (USA) (En,Ja,Fr,De,Es,It) (v2.01)",
        96,
        ["masterpiece", "horror"],
        "Best horror game ever made. Peak psychological terror",
    ),
    (
        "Devil May Cry 3 - Dante's Awakening (USA) (En,Ja) (Special Edition)",
        95,
        ["masterpiece", "action"],
        "Invented stylish action. Turbo mode",
    ),
    (
        "Ookami (USA)",
        95,
        ["masterpiece", "action-adventure", "hidden-gem"],
        "Cel-shaded Zelda. Criminally undersold",
    ),
    (
        "Dragon Quest VIII - Journey of the Cursed King (USA)",
        95,
        ["masterpiece", "jrpg"],
        "Most charming JRPG ever. Toriyama art",
    ),
    (
        "Ratchet & Clank - Up Your Arsenal (USA) (En,Fr,Es)",
        95,
        ["masterpiece", "platformer"],
        "Peak of the series. Perfect fun",
    ),
]
...
PS2_EXCELLENT = [
    ...
    (
        ...
        94,
        ["classic", "open-world"],
        "80s Miami perfection",
    ),
    (
        "Grand Theft Auto III (USA)",
        93,
        ["genre-defining", "open-world"],
        "Invented the 3D open world genre",
    ),
    ("Devil May Cry (USA)", 93, ["genre-defining", "action"], "Birth of stylish action"),
    (
        "Metal Gear Solid 2 - Substance (USA)",
        93,
        ["classic", "stealth"],
        "Substance > Sons of Liberty. Extra content",
    ),
    (
        "Jak and Daxter - The Precursor Legacy (USA) (En,Fr,De,Es,It)",
        92,
        ["classic", "platformer"],
        "Naughty Dog's 3D platformer masterclass",
    ),
    (
        "Ratchet & Clank - Going Commando (USA) (v2.00)",
        92,
        ["classic", "platformer"],
        "Perfect sequel. Introduced RPG elements",
    ),
    (
        "Ratchet & Clank (USA) (En,Fr,De,Es,It)",
        91,
        ["classic", "platformer"],
        "Inventive weapons + humor",
    ),
    (
        "Silent Hill 3 (USA) (En,Ja,Fr,De,Es,It,Ko)",
        91,
        ["classic", "horror"],
        "Heather's story. Visceral horror",
    ),
    (
        "Resident Evil 4 (USA)",
        91,
        ["genre-defining", "horror"],
        "Reinvented survival horror. Over-the-shoulder",
    ),
    (
        "Ace Combat 04 - Shattered Skies (USA)",
        91,
        ["classic", "flight"],
        "Best arcade flight game ever",
    ),
    (
        "Ace Combat 5 - The Unsung War (USA) (En,Ja)",
        90,
        ["classic", "flight"],
        "Emotional flight combat",
    ),
    (
        "Jak II (USA) (En,Fr,De,Es,It,Ja,Ko)",
        90,
        ["classic", "platformer"],
        "Dark open-world pivot. Bold",
    ),
    (
        "Jak 3 (USA) (En,Fr,De,Es,It,Ja,Ko)",
        90,
        ["classic", "platformer"],
        "Desert wasteland + Light Jak",
    ),
    (
        "Sly Cooper and the Thievius Raccoonus (USA)",
        90,
        ["classic", "platformer"],
        "Stealth-platformer gem",
    ),
    ...
    (
        ...
        89,
        ["classic", "platformer"],
        "Heist gameplay. Satisfying conclusion",
    ),
    ...
    (
        ...
        87,
        ["classic", "fighting"],
        "Peak 2D fighter on PS2",
    ),
    (
        "Dark Cloud 2 (USA)",
        87,
        ["hidden-gem", "action-rpg"],
        "Whimsical dungeon crawler + town building",
    ),
    ...
    (
        "Star Ocean - Till the End of Time (USA) (Disc 1)",
        86,
        ["classic", "jrpg"],
        "Real-time combat JRPG. Mind-bending plot",
    ),
    ...
    (
        ...
        86,
        ["hidden-gem", "jrpg"],
        "Beautiful platformer-RPG hybrid",
    ),
    ...
    (
        "Xenosaga Episode I - Der Wille zur Macht (USA)",
        85,
        ["classic", "jrpg"],
        "Spiritual successor to Xenogears",
    ),
    (
        "Xenosaga Episode III - Also sprach Zarathustra (USA) (Disc 1)",
        85,
        ["classic", "jrpg"],
        "Series conclusion. Best combat",
    ),
    (
        "Xenosaga Episode III - Also sprach Zarathustra (USA) (Disc 2)",
        85,
        ["multi-disc"],
        "Xenosaga III Disc 2",
    ),
    (
        ...
        85,
        ["classic", "jrpg"],
        "Featuring Dante. Press-turn combat perfection",
    ),
    (
        "Shin Megami Tensei - Digital Devil Saga (USA)",
        85,
        ["hidden-gem", "jrpg"],
        "Atma devouring. Dark and brilliant",
    ),
    (
        "Shin Megami Tensei - Digital Devil Saga 2 (USA)",
        85,
        ["hidden-gem", "jrpg"],
        "Conclusion of DDS duology",
    ),
    (
        "Disgaea - Hour of Darkness (USA)",
        85,
        ["classic", "strategy-rpg"],
        "Infinite depth SRPG. Level 9999",
    ),
    ...
    (
        ...
        85,
        ["hidden-gem", "fps"],
        "Goldeneye spiritual successor. Local MP gold",
    ),
    (
        "TimeSplitters - Future Perfect (USA)",
        85,
        ["hidden-gem", "fps"],
        "Best TS. Story + multiplayer",
    ),
]
...
PS2_GREAT = [
    ...
    # Score 75-84.
    (
        "Ace Combat Zero - The Belkan War (USA)",
        84,
        ["classic", "flight"],
        "Prequel. Ace style system",
    ),
    (
        "Beyond Good & Evil (USA) (En,Fr,De,Es,It)",
        84,
        ["hidden-gem", "action-adventure"],
        "Jade's adventure. Cultclassic",
    ),
    (
        "Baldur's Gate - Dark Alliance (USA)",
        84,
        ["classic", "action-rpg"],
        "Couch co-op dungeon crawler",
    ),
    (
        "Baldur's Gate - Dark Alliance II (USA)",
        83,
        ["classic", "action-rpg"],
        "More co-op dungeon crawling",
    ),
    (
        "Champions of Norrath (USA)",
        83,
        ["hidden-gem", "action-rpg"],
        "Baldur's Gate style. 4 player co-op",
    ),
    ...
    (
        "Prince of Persia - The Sands of Time (USA)",
        84,
        ["classic", "action-adventure"],
        "Time rewind mechanic. Elegant",
    ),
    (
        "Prince of Persia - Warrior Within (USA)",
        82,
        ["classic", "action-adventure"],
        "Darker, but excellent combat",
    ),
    (
    ...
    (
        "Zone of the Enders - The 2nd Runner (USA)",
        83,
        ["hidden-gem", "mech-action"],
        "Kojima mech action. Gorgeous",
    ),
    ...
    (
        "Psychonauts (USA)",
        84,
        ["hidden-gem", "platformer"],
        "Tim Schafer's mind-diving masterpiece",
    ),
    ...
    (
        ...
        80,
        ["hidden-gem", "strategy-rpg"],
        "Working Designs' last game. Tactical",
    ),
    ...
    (
        "Makai Kingdom - Chronicles of the Sacred Tome (USA)",
        80,
        ["hidden-gem", "strategy-rpg"],
        "NIS vehicle-based SRPG",
    ),
    (
        "Disgaea 2 - Cursed Memories (USA)",
        83,
        ["classic", "strategy-rpg"],
        "Refined Disgaea. Better story",
    ),
    ...
    (
        "Breath of Fire - Dragon Quarter (USA)",
        80,
        ["hidden-gem", "jrpg"],
        "Roguelike JRPG. Ahead of its time",
    ),
    ...
    (
        ...
        79,
        ["hidden-gem", "jrpg"],
        "Beginning of Atelier on PS2",
    ),
    (
        "Atelier Iris 2 - The Azoth of Destiny (USA)",
        79,
        ["hidden-gem", "jrpg"],
        "Improved alchemy system",
    ),
    (
        "Mana Khemia - Alchemists of Al-Revis (USA)",
        80,
        ["hidden-gem", "jrpg"],
        "Best Atelier-era game. School setting",
    ),
    (
        "Stella Deus - The Gate of Eternity (USA)",
        78,
        ["hidden-gem", "strategy-rpg"],
        "Atlus SRPG. Beautiful art",
    ),
    (
        "Romancing SaGa - Minstrel Song (USA)",
        78,
        ["hidden-gem", "jrpg"],
        "Non-linear SaGa. Acquired taste, great depth",
    ),
    ...
    (
        ...
        79,
        ["hidden-gem", "jrpg"],
        "Music magic system. Unique",
    ),
    (
        "Ar Tonelico II - Melody of Metafalica (USA)",
        79,
        ["hidden-gem", "jrpg"],
        "Refined song crafting",
    ),
    ...
    (
        ".hack--G.U. Vol. 2--Reminisce (USA)",
        80,
        ["hidden-gem", "jrpg"],
        "Continues Haseo's journey",
    ),
    ...
    (
        "Maximo - Ghosts to Glory (USA)",
        80,
        ["hidden-gem", "platformer"],
        "Ghosts 'n Goblins successor",
    ),
    ("Maximo vs. Army of Zin (USA)", 79, ["hidden-gem", "platformer"], "Improved sequel"),
    (
        "The Warriors (USA)",
        82,
        ["hidden-gem", "beat-em-up"],
        "Rockstar meets brawler. Can you dig it",
    ),
    ...
    (
        "Onimusha 2 - Samurai's Destiny (USA)",
        80,
        ["classic", "action"],
        "Gift system. Branching paths",
    ),
    (
        "Onimusha - Dawn of Dreams (USA) (Disc 1)",
        80,
        ["classic", "action"],
        "Final Onimusha. Huge game",
    ),
    ...
    (
        "Street Fighter Anniversary Collection (USA)",
        82,
        ["compilation", "fighting"],
        "SF2 + SF3 Third Strike",
    ),
    (
        "Capcom vs. SNK 2 - Mark of the Millennium 2001 (USA)",
        83,
        ["classic", "fighting"],
        "Ultimate crossover fighter",
    ),
    (
    ...
    (
        ...
        80,
        ["classic", "action-rpg"],
        "4-player couch co-op dungeon crawl",
    ),
    (
        "X-Men Legends II - Rise of Apocalypse (USA)",
        80,
        ["classic", "action-rpg"],
        "4-player co-op Marvel RPG",
    ),
    ...
    (
        "Need for Speed - Most Wanted (USA) (En,Fr,Es) (v1.02)",
        82,
        ["classic", "racing"],
        "Best NFS. Police chases",
    ),
    (
        "Need for Speed - Underground 2 (USA) (En,Fr,Es)",
        81,
        ["classic", "racing"],
        "Street racing + customization",
    ),
    (
    ...
    (
        ...
        79,
        ["hidden-gem", "racing"],
        "Mountain bike combat racing. Underrated",
    ),
    ("ATV Offroad Fury 2 (USA)", 78, ["hidden-gem", "racing"], "Online PS2 pioneer. Great tracks"),
    (
        "WWE SmackDown! Here Comes the Pain (USA)",
        83,
        ["classic", "wrestling"],
    ...
    (
        "Splinter Cell - Chaos Theory (USA) (En,Fr)",
        82,
        ["classic", "stealth"],
        "Best Splinter Cell",
    ),
    ...
    (
        ...
        80,
        ["hidden-gem", "fps"],
        "Criterion's gun porn FPS. Incredible destruction",
    ),
    (
        "Killzone (USA, Europe, Australia)",
        78,
        ["classic", "fps"],
        "PS2's Halo killer attempt. Atmospheric",
    ),
    (
        "Mercenaries - Playground of Destruction (USA) (En,Fr,Es)",
        81,
        ["hidden-gem", "open-world"],
        "Open-world military sandbox",
    ),
    ...
    (
        ...
        80,
        ["hidden-gem", "shooter"],
        "Squad-based freedom fighting. Underrated gem",
    ),
    (
        "Psi-Ops - The Mindgate Conspiracy (USA)",
        79,
        ["hidden-gem", "action"],
        "Telekinesis physics. Ahead of its time",
    ),
    ...
    (
        "Fatal Frame II - Crimson Butterfly (USA) (Director's Cut)",
        82,
        ["hidden-gem", "horror"],
        "Best in series. Twin village",
    ),
    ...
    (
        "Indigo Prophecy (USA) (En,Fr)",
        80,
        ["classic", "adventure"],
        "David Cage before Heavy Rain. QTE narrative",
    ),
    (
        "Jak X - Combat Racing (USA)",
        79,
        ["hidden-gem", "racing"],
        "Jak universe racing. Surprisingly great",
    ),
    (
        "Ratchet - Deadlocked (USA) (En,Fr,Es)",
        80,
        ["classic", "action"],
        "Gladiator Ratchet. Pure combat",
    ),
    ...
    (
        ...
        83,
        ["hidden-gem", "beat-em-up"],
        "Clover's last game. Insane difficulty. Cult classic",
    ),
    ("Under the Skin (USA)", 75, ["hidden-gem", "action"], "Weird Capcom gem. Alien pranking"),
    (
        "Gregory Horror Show (Europe) (En,Fr,De,Es,It)",
        76,
        ["hidden-gem", "horror-adventure"],
        "Unique art style. Hotel of horrors",
    ),
]
...
PS2_NOTABLE = [
    ...
    (
        "Blood Will Tell - Tezuka Osamu's Dororo (USA)",
        76,
        ["hidden-gem", "action"],
        "Osamu Tezuka's manga. 48 demons",
    ),
    ...
    (
        "Shadow Hearts - Covenant (USA) (Disc 1)",
        78,
        ["hidden-gem", "jrpg"],
        "Best Shadow Hearts. WWI epic",
    ),
    (
        "Shadow Hearts - Covenant (USA) (Disc 2)",
        78,
        ["multi-disc"],
        "Shadow Hearts Covenant Disc 2",
    ),
    (
        "Shadow Hearts - From the New World (USA)",
        75,
        ["hidden-gem", "jrpg"],
        "Americas setting. Lighter tone",
    ),
    (
        "Xenosaga Episode II - Jenseits von Gut und Boese (USA) (Disc 1)",
        76,
        ["classic", "jrpg"],
        "Weakest Xenosaga but still needed",
    ),
    (
        "Xenosaga Episode II - Jenseits von Gut und Boese (USA) (Disc 2)",
        76,
        ["multi-disc"],
        "Xenosaga II Disc 2",
    ),
    ...
    (
        ...
        71,
        ["hidden-gem", "jrpg"],
        "Time loop RPG. Flawed but interesting",
    ),
    ...
    (
        "Test Drive - Eve of Destruction (USA)",
        72,
        ["hidden-gem", "racing"],
        "Demolition derby. Pure chaos",
    ),
    (
        "Def Jam - Fight for NY (USA)",
        78,
        ["hidden-gem", "fighting"],
        "Hip-hop fighting. Incredibly fun",
    ),
    ...
    (
        ...
        77,
        ["compilation", "run-and-gun"],
        "All Metal Slugs on one disc",
    ),
    (
        "Taiko no Tatsujin - Taiko Drum Master (USA)",
        76,
        ["hidden-gem", "rhythm"],
        "Namco drum game. Pure joy",
    ),
    ...
    (
        "Space Channel 5 - Special Edition (USA)",
        76,
        ["classic", "rhythm"],
        "Ulala's dancing. Sega charm",
    ),
    (
        "Rez (USA)",
        77,
        ["genre-defining", "rhythm-shooter"],
        "Synesthesia shooter. Art game pioneer",
    ),
    (
        "Klonoa 2 - Lunatea's Veil (USA)",
        78,
        ["hidden-gem", "platformer"],
        "Beautiful 2.5D platformer",
    ),
    (
        "Ty the Tasmanian Tiger (USA)",
        73,
        ["hidden-gem", "platformer"],
        "Australian platformer. Solid fun",
    ),
    (
    ...
    (
        "Sphinx and the Cursed Mummy (USA)",
        75,
        ["hidden-gem", "action-adventure"],
        "Egyptian Zelda-like",
    ),
    (
        "Primal (USA) (En,Fr,De,Es,It)",
        75,
        ["hidden-gem", "action-adventure"],
        "Demon realms. Unique premise",
    ),
    ...
    (
        ...
        73,
        ["hidden-gem", "horror"],
        "Capcom survival horror. Chase sequences",
    ),
    ...
    (
        ...
        76,
        ["hidden-gem", "horror"],
        "Japan Studio horror. Sightjack mechanic",
    ),
    (
    ...
    (
        "Aliens vs. Predator - Extinction (USA)",
        72,
        ["hidden-gem", "strategy"],
        "RTS on PS2. Three factions",
    ),
    ...
    (
        "LEGO Star Wars II - The Original Trilogy (USA) (En,Fr,Es)",
        77,
        ["classic", "action-adventure"],
        "Started the LEGO empire",
    ),
    (
        "LEGO Star Wars - The Video Game (USA) (En,Fr,Es)",
        76,
        ["classic", "action-adventure"],
        "Prequels in LEGO. Charming",
    ),
    ...
    (
        ...
        77,
        ["classic", "fighting"],
        "161 characters. Spectacle",
    ),
    (
        "Naruto - Ultimate Ninja 3 (USA) (En,Ja)",
        74,
        ["classic", "fighting"],
        "Best Naruto PS2 fighter",
    ),
...
def build_ps2_curation() -> PlatformCuration:
    ...
    for name, score, tags, note in PS2_GREAT:
        games.append(
            CuratedGame(
                name=name,
                tier=GameTier.EXCELLENT if score >= 85 else GameTier.GREAT,
                score=score,
                tags=tags,
                note=note,
            )
...
XBOX_ESSENTIAL = [
    (
        "Halo - Combat Evolved (USA)",
        100,
        ["masterpiece", "genre-defining"],
        "Changed console FPS forever",
    ),
    ...
    (
        "Tom Clancy's Splinter Cell (USA) (En,Fr)",
        94,
        ["masterpiece", "stealth"],
        "Defined stealth action. Sam Fisher",
    ),
    (
        "Ninja Gaiden (USA)",
        97,
        ["masterpiece", "action"],
        "Best action game of gen. Itagaki's opus",
    ),
]

XBOX_EXCELLENT = [
    (
        "Tom Clancy's Splinter Cell - Chaos Theory (USA) (En,Fr)",
        93,
        ["classic", "stealth"],
        "Best Splinter Cell. Co-op stealth",
    ),
    (
        "Tom Clancy's Splinter Cell - Pandora Tomorrow (USA) (En,Fr)",
        88,
        ["classic", "stealth"],
        "Spies vs Mercs multiplayer",
    ),
    (
        "Morrowind - The Elder Scrolls III - Game of the Year Edition (USA)",
        94,
        ["masterpiece", "rpg"],
        "Deepest Elder Scrolls world",
    ),
    ("Jade Empire (USA)", 90, ["classic", "rpg"], "BioWare martial arts RPG"),
    (
        "Star Wars - Knights of the Old Republic II - The Sith Lords (USA)",
        90,
        ["classic", "rpg"],
        "Obsidian's darker KOTOR",
    ),
    ("Burnout 3 - Takedown (USA)", 92, ["classic", "racing"], "Best arcade racer ever"),
    (
        "Jet Set Radio Future (USA) (En,Ja)",
        88,
        ["hidden-gem", "action"],
        "Cel-shaded skating graffiti",
    ),
    ("Panzer Dragoon Orta (USA)", 89, ["hidden-gem", "rail-shooter"], "Gorgeous. Best of its kind"),
    (
        "Crimson Skies - High Road to Revenge (USA)",
        88,
        ["hidden-gem", "flight-action"],
        "Arcade dogfighting. Xbox Live pioneer",
    ),
    ...
    (
        ...
        86,
        ["hidden-gem", "action-adventure"],
        "Jade's quest. Best version",
    ),
    (
        "Prince of Persia - The Sands of Time (USA)",
        88,
        ["classic", "action-adventure"],
        "Smooth 60fps on Xbox",
    ),
]

XBOX_GREAT = [
    (
        "Blinx - The Time Sweeper (USA)",
        80,
        ["hidden-gem", "platformer"],
        "Time-control platformer. Xbox exclusive",
    ),
    (
        "Conker - Live & Reloaded (USA)",
        84,
        ["classic", "platformer"],
        "Mature platformer. Rares farewell",
    ),
    (
        "Oddworld - Munch's Oddysee (USA)",
        81,
        ["classic", "platformer"],
        "3D Oddworld. Launch title",
    ),
    (
        "Oddworld - Stranger's Wrath (USA)",
        85,
        ["hidden-gem", "fps-action"],
        "Live ammo. Brilliant hybrid",
    ),
    ("MechAssault (USA) (En,Fr)", 82, ["hidden-gem", "mech-action"], "Xbox Live mech combat"),
    (
        "MechAssault 2 - Lone Wolf (USA)",
        80,
        ["hidden-gem", "mech-action"],
        "Hijack mechs. Expanded",
    ),
    (
        "Phantom Dust (USA, Japan)",
        83,
        ["hidden-gem", "action"],
        "Card-based arena combat. Ahead of its time",
    ),
    ("Otogi - Myth of Demons (USA)", 82, ["hidden-gem", "action"], "FromSoft stylish action"),
    (
        "Otogi 2 - Immortal Warriors (USA)",
        82,
        ["hidden-gem", "action"],
        "More FromSoft demon slaying",
    ),
    (
        "Grabbed by the Ghoulies (USA)",
        75,
        ["hidden-gem", "beat-em-up"],
        "Rare's haunted house brawler",
    ),
    ...
    (
        ...
        82,
        ["classic", "action-rpg"],
        "Best version. Co-op dungeon crawling",
    ),
    ...
    (
        "Call of Cthulhu - Dark Corners of the Earth (USA)",
        80,
        ["hidden-gem", "horror"],
        "Lovecraftian horror FPS",
    ),
    (
        "Stubbs the Zombie in Rebel Without a Pulse (USA)",
        78,
        ["hidden-gem", "action"],
        "Play as the zombie. Comedy horror",
    ),
    (
        "Metal Wolf Chaos (Japan)",
        75,
        ["hidden-gem", "mech-action"],
        "President in a mech. Japan only. Legendary",
    ),
...
XBOX_NOTABLE = [
    (
        "Tony Hawk's Pro Skater 2x (USA)",
        78,
        ["classic", "sports"],
        "THPS1+2 remastered. Xbox launch",
    ),
    ...
    (
        "Quantum Redshift (USA, Europe)",
        76,
        ["hidden-gem", "racing"],
        "Wipeout-style anti-grav racer",
    ),
    ...
    (
        "Project Gotham Racing 2 (USA, Europe)",
        84,
        ["classic", "racing"],
        "Kudos system. Gorgeous cities",
    ),
    ...
    (
        "The Chronicles of Riddick - Escape from Butcher Bay (USA)",
        88,
        ["hidden-gem", "fps"],
        "Best movie game ever. Starbreeze masterpiece",
    ),
...
def main():
    ...
    ps2_files = [
        p.stem
        for p in sorted(
            (workspace / "output" / "redump-1g1r-eng-chd-batocera-v2" / "ps2").glob("*.chd")
        )
    ]
    ...
    xbox_files = [
        p.stem
        for p in sorted(
            (workspace / "output" / "redump-1g1r-eng-chd-batocera-v2" / "xbox").glob("*.iso")
        )
    ]
