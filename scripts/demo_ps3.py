...
def main():
    ...
    print("    rpcs3: Folder structure BLUS30455/ (best RPCS3 compatibility)")
    print("    ps3netsrv: .iso.gz (50% space savings for network streaming)")
    print("    ps3-cfw: Folder structure BLUS30455/ (CFW local storage)")
    print("    batocera: Folder structure BLUS30455.ps3/ (Batocera requirement)")
    print()
    print("Next steps:")
