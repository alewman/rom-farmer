    ...
    try:
        ...
        if total_games > 0:
            ...
            for system in sorted(systems):
                ...
                print(
                    f"     • {system[0]}: {count:,} games ({with_md5:,} with MD5 - {md5_percent:.1f}%)"
                )
        ...
        if total_trans > 0:
            ...
            linked = (
                ...
                .filter(ROMTransformation.game_id.isnot(None))
                .count()
            )
            ...
            print("   • Formats:")
            formats = (
                session.query(ROMTransformation.source_format, ROMTransformation.final_format)
                .distinct()
                .all()
            )
