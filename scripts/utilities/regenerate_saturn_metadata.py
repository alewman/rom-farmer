...
def main():
    ...
    if gamelist_path.exists():
        ...
        print(f"Games with description: {games_with_desc} ({games_with_desc/len(games)*100:.1f}%)")
        print(f"Games with rating: {games_with_rating} ({games_with_rating/len(games)*100:.1f}%)")
