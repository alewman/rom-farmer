...
def main():
    ...
    multi_disc_zips = [z for z in all_zips if "(Disc" in z.name or "(Disk" in z.name][
        :10
    ]  # First 10 multi-disc ZIPs
    ...
    try:
        ...
        db = MetadataDatabase(
            ImportedPath(__file__).parent.parent / "metadata" / "database" / "romfarmer.db"
        )
