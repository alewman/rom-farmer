...
def main():
    ...
    dat_path = Path(
        "/data/emu/dats/redump.retool.1g1r.usa/Sony - PlayStation (2024-12-20 19-04-10) (Retool 2025-02-20 22-15-31) (1,476) (-dn) [-AaBbcdekmMoPrv].dat"
    )
    ...
    console.print("[yellow]DAT:[/yellow] 1G1R USA (1,476 games)")
